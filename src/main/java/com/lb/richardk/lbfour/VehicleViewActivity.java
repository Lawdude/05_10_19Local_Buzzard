...
public class VehicleViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carList = (RecyclerView) findViewById(R.id.RewardsRecycleView);
    ...
    public static class CarViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setVehicleReg(String reg) {
            TextView carReg = (TextView) mView.findViewById(R.id.companyName);
            carReg.setText(reg);
        }

        public void setCity(String cit) {
            TextView message = (TextView) mView.findViewById(R.id.discountCode);
            message.setText(cit);
        }
    }
}